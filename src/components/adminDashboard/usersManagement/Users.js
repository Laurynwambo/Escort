                ...
                <div className="d-flex" id="wrapper">
                    ...
                    <div id="page-content-wrapper">
                        ...
                        <button className="btn btn-link mt-3" id="menu-toggle"><FontAwesomeIcon icon={faList}/></button>
                            <button className="btn btn-outline-primary float-right mt-3 mr-2" data-toggle="modal" data-target="#add-user-modal" onClick={this.addUser}><FontAwesomeIcon icon={faPlus}/> Add User</button>
